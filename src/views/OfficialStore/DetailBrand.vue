        ...
        <div class="container">
            <div class="box-page-courses">
                ...
                <div class="right-page-courses">
                    ...
                    <div class="box-banner-brand">
                        <div class="cover-banner-brand">
                            <img src="@/assets/images/brand-alt-2.jpg" alt="">
                        </div>
                    </div>
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-7">
                            <div class="box-section-page">
                                <div class="sub-section-page mt-3">
                                    Menampilkan 1 - 24 produk dari total 35rb+ untuk brand <b class="clr-black-dark">"Koepoe"</b>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="box-filter">
                        ...
                        <div class="box-option-alt">
                            <div class="form-check list-option-alt">
                                <input class="form-check-input" name="radio" type="radio" id="brandM1" value="option1">
                                <label class="form-check-label" for="brandM1">Blue Band</label>
                            </div>
                            <div class="form-check list-option-alt">
                                <input class="form-check-input" name="radio" type="radio" id="brandM2" value="option2">
                                <label class="form-check-label" for="brandM2">Koepoe</label>
                            </div>
                            <div class="form-check list-option-alt">
                                <input class="form-check-input" name="radio" type="radio" id="brandM3" value="option3">
                                <label class="form-check-label" for="brandM3">Bungasari</label>
                            </div>
                            <div class="form-check list-option-alt">
                                <input class="form-check-input" name="radio" type="radio" id="brandM4" value="option4">
                                <label class="form-check-label" for="brandM4">Palmia</label>
                            </div>
                            <div class="form-check list-option-alt">
                                <input class="form-check-input" name="radio" type="radio" id="brandM5" value="option5">
                                <label class="form-check-label" for="brandM5">Nestle</label>
                            </div>
                            <div class="form-check list-option-alt">
                                <input class="form-check-input" type="radio" id="brandM6" value="option6">
                                <label class="form-check-label" for="brandM6">Indomilk</label>
                            </div>
                            <div class="form-check list-option-alt">
                                <input class="form-check-input" name="radio" type="radio" id="brandM7" value="option7">
                                <label class="form-check-label" for="brandM7">Rose Brand</label>
                            </div>
                            <div class="form-check list-option-alt">
                                <input class="form-check-input" name="radio" type="radio" id="brandM8" value="option8">
